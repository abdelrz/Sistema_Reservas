...
public class DialogoExportacionAExcelExitosa extends javax.swing.JDialog {

    public DialogoExportacionAExcelExitosa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Exportación a Excel exitosa");

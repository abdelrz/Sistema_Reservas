...
public class DialogoBienvenido extends javax.swing.JDialog {

    public DialogoBienvenido(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Bienvenido al sistema, Admin.");

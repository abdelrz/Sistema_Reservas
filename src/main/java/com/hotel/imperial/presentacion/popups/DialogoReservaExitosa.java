...
public class DialogoReservaExitosa extends javax.swing.JDialog {

    public DialogoReservaExitosa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Reserva registrada correctamente");

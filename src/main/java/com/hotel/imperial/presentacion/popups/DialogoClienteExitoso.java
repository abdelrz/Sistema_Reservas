...
public class DialogoClienteExitoso extends javax.swing.JDialog {

    public DialogoClienteExitoso(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cliente registrado correctamente");
